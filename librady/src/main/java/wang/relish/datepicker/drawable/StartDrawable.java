...
/**
 * MonthView的开始日期Item样式
 * Created by 王鑫 on 2017/3/17.
 */
public class StartDrawable extends CustomDrawable {
    ...
    public void draw(@NonNull Canvas canvas) {
        ...
        canvas.drawRect(startX + mCellSize / 2, startY + mCellSize / 2 - mRadius, startX + mCellSize, startY + mCellSize / 2 + mRadius, mPaint);
        //画中间的圆
        mPaint.setColor(MonthStyle.ENDS_COLOR);
